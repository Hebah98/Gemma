...
import 'package:gemma/views/signup_parents.dart';
    ...
    if (formKey.currentState.validate()) {
      ...
      authService
        ...
        if (val != null) {
          ...
          Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => Educator()));
        }else{
          ...
          showDialog(
              ...
              builder: (_) => AlertDialog(
                ...
                content: Text('There is a problem in e-mail or password please try again'),
              )
          );
        }
      });
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          //widget.toggle();
                          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>SignUpParent()));
                        },
                        child: Container(
